...
import 'package:qwizapp/AllQuestionWidget/thereyiQue/ScreenChange.dart';
import 'package:qwizapp/AllQuestionWidget/thereyiQue/que.dart';
import 'package:qwizapp/CategoryWidgets/result.dart';

class phthon extends StatefulWidget {
  const phthon({super.key});

  @override
  State<phthon> createState() => _phthonState();
}

class _phthonState extends State<phthon> {
